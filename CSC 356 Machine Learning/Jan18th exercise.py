...
#TODO: Get a working version of the program (Check?)
...
def lagrange(x, points):
    ...
    f3 = (ys[3] *
          ...
          (x - xs[2])/(xs[3] - xs[2]))
    return f0 + f1 + f2 + f3
    #TODO: Try to find a way to define f0, f1, f2, f3 more concisely
...
def main():
    ...
    #TODO: Define a numpy array that contains a large number of points on the interplating curve
